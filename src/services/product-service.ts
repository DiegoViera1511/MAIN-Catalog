...
export async function uploadProductImageService(filePath: string, imageData: File){
    try {
...
export async function updateProductService(productId: number, updatedProduct: ProductType){
    try {
...
export async function deleteUploadedImagesService(uploadedFilesPaths: string[]){
    try {
...
export async function deleteProductByIdService(productId: number, productImages: string[]){
    try {
