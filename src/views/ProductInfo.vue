...
<template>
  ...
  <div
    v-else-if="product"
    class="flex flex-1 flex-col items-center justify-center gap-4 min-w-full sm:w-fit"
  >
    <div
    ...
    <div class="flex flex-col gap-4 w-full px-4 sm:w-fit">
      <div class="flex flex-col gap-2">
        ...
        <span class="text-md text-gray-500 font-medium sm:w-[600px]">{{
          product.description
        }}</span>
        <div>
      ...
      <hr class="w-full" />
      <div v-if="product.colors.length > 0" class="grid grid-cols-5 sm:w-1/2">
        <div
      ...
      <p
        ...
        class="text-md text-gray-500 font-medium"
      >
        {{ SpanishColors[checkColor as Colors] }}
      </p>
      ...
      <div v-if="product.sizes.length > 0" class="grid grid-cols-5 sm:w-1/2">
        <div
          ...
          :class="
            selectedSize === index
              ? 'border-gray-700 text-black dark:text-white border-5 dark:border-white'
      ...
      <div
        class="flex sticky bottom-5 top-auto items-center justify-center w-full"
      >
        <Button
