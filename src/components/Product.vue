  ...
  <div class="flex flex-col w-full hover:shadow-sm items-center justify-center gap-2 py-3 rounded-md">
    ...
    <div class="flex flex-col w-full justify-start items-start dark:text-white">
      <div class="flex flex-row items-center w-full justify-between">
        ...
        <div v-show="!props.product.available" class= "flex items-center justify-center border-2 border-red-800 rounded-full px-3 text-red-800 font-medium">
          Agotado
        </div>
      </div>
      <div>
        <span
            v-if="props.product.discount_price"
        ...
        <span
            class="text-md font-bold"
            :class="props.product.discount_price ? 'line-through text-red-700 ml-2' : ''"
        >
              ${{ props.product.price }}
        </span>
      </div>
